...
print(" The number of issues that talk about refactoring are (Evaluation Criteria) : ", (len(unique_commit_hashes_with_refactoring_reported)/total_num_issues)*100 )
    

c = (len(unique_commit_hashes_with_refactoring_reported)/total_num_issues)*100 
d = np.array([c, 100 - c])
myexplode = [0.2,0]
fig1, ax1 = plt.subplots()
plotLabel = ["Refactoring related Issues","Other Issues"]
