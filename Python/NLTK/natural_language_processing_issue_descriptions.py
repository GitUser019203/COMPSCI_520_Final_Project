...
# Initialize an issue linked commits model
issue_linked_commits_model = IssueLinkedCommitsModel(issue_titles_model=issue_titles_model)
issue_linked_commits_model.load()

# Initialize an issue descriptions model
issue_descs_model = IssueDescriptionsModel(issue_titles_model=issue_titles_model, issue_linked_commits_model=issue_linked_commits_model)
...
for j, project in enumerate(projectCollection):
    ...
    for commit in commits:
        ...
        issue_descs_model.mine_commit(commit)
